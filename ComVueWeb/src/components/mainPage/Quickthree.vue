        ...
        <div class="box_center">
            ...
            <div class="title_box box_h">
                ...
                <div class="title_countdown_box">
                    <h3>投注倒计时&emsp;<strong>{{NowLssue}}</strong>&emsp;期</h3>
                    <div>
                ...
                <!-- 往期中奖号码 -->
                <div class="title_countdown_box">
                    <h3>开奖号码&emsp;<strong>{{LastLssue}}</strong>&emsp;期<router-link class="to_zst" :to="{name:'Trendmap',query:{id:$route.query.id,index:$route.query.index}}" target="_blank">
                        <span class="iconfont icon-zoushitu"></span>&ensp;走势</router-link></h3>
                    <!-- 中奖号码盒子 -->
                    <div class="winning_main box_h" style="margin-top: 10px">
                        <div class="quick_winning_item Sievesnum_box" v-for="(item,index) in LastNum" :key="index">
                            ...
                            <div class="seven" v-if="item==0">
                                <img v-if="index === 0" src="../../static/img/touzi_Draw7.gif" alt="">
                                <img v-if="index === 1" src="../../static/img/touzi_Draw8.gif" alt="">
                                <img v-if="index === 2" src="../../static/img/touzi_Draw9.gif" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>至少选择1个和值（3个号码之和）进行投注，所选和值与开奖的3个号码的和值相同即中奖。(和值型态3～10为小，11～18为大)</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div>-->
<!--                                                    <p>投注方案：5<br/>开奖号码：113,即中和值</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
...
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>至少选择1个值(大小单双)进行投注，所选和值3-10为小,11-18为大,3.5.7..为单,4.6.8..为双</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div>-->
<!--                                                    <p>投注方案：大<br/>开奖号码：556,即中奖</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
...
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>对所有相同的三个号码（111、222、333、444、555、666）进行投注，任意号码开出即中奖。</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div style="width:248px;left:-249px">-->
<!--                                                    <p>投注方案：三同号通选<br/>开奖号码：111,即中三同号通选</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    ...
                                    <div class="quick_three_numlist cf">
                                        <div :class='["quick_three_numitem","box_s","dom_center",item.state == "true"?"numitem_select big_icon":""]'
                                             ...
                                             :data-state="item.state"
                                             :data-index="index">
                                            <strong class="quick_three_num"
                                                    style="font-weight: normal">{{item.name}}</strong>
                                        </div>
                                    </div>
                                </template>
                                <!-- 三同号单选 -->
...
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>对相同的三个号码（111、222、333、444、555、666）中的任意一个进行投注，所选号码开出即中奖。</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div style="width:248px;left:-249px">-->
<!--                                                    <p>投注方案：111<br/>开奖号码：111,即中三同号单选</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    <!-- 号码列表 -->
                                    <div class="quick_three_numlist cf">
                                        <gameType :gametype="gameTypeAry" @setary="setSelectAry" ref="empty"
                                                  @setbet="setBetNum"
                                                  :navid="navNum"></gameType>
                                    </div>
                                </template>
                                <!-- 三不同号单选 -->
                                <template v-if="navNum==122">
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>从1～6中任选3个或多个号码，所选号码与开奖号码的3个号码相同即中奖。</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div style="width:248px;left:-249px">-->
<!--                                                    <p>投注方案：123<br/>开奖号码：123,即中三不同号单选</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    ...
                                    <div class="quick_three_numlist">
                                        <gameType :navid="navNum" :gametype="gameTypeAry" @setary="setSelectAry"
                                                  ref="empty"
                                                  @setbet="setBetNum"></gameType>
                                    </div>
                                </template>
                                <template v-if="navNum==123">
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>对所有3个相连的号码（123、234、345、456）进行投注，任意号码开出即中奖。</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div style="width:248px;left:-249px">-->
<!--                                                    <p>投注方案：三连号通选<br/>开奖号码：456,即中三连号通选</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
...
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>从1～6中任选1个或多个号码，选号与奖号（包含两个1～6，不限顺序）相同，即中奖。</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div style="width:248px;left:-249px">-->
<!--                                                    <p>投注方案：1<br/>开奖号码：456,即中二同号复选</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    ...
                                    <div class="quick_three_numlist cf">
                                        <gameType :navid="navNum" :gametype="gameTypeAry" @setary="setSelectAry"
                                                  ref="empty"
                                                  @calc="CalcMount"></gameType>
                                    </div>
                                </template>
                                <!-- 二同号单选 -->
                                <template v-if="navNum==125">
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>选择1对相同号码和1个不同号码投注，选号与奖号相同（顺序不限，投注的二同号和不同号不可相同），即中奖。</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div style="width:248px;left:-249px">-->
<!--                                                    <p>投注方案：二同号1，不同号2<br/>开奖号码：112,即中二同号单选</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    <!-- 号码列表 -->
                                    <div class="quick_three_numlist cf">
                                        <gameTypes :navid="navNum" :gameAry="gameSenAry" ref="empty" @setbet="setBetNum"
                                                   @getdata="getData"></gameTypes>
                                    </div>
                                </template>
                                <!-- 二不同号 -->
                                <template v-if="navNum==126">
<!--                                    <div class="demo_case">-->
<!--                                        <p><span class="iconfont icon-dengpao"></span>从1～6中任选2个或多个号码，所选号码与开奖号码任意2个号码相同，即中奖。</p>-->
<!--                                        <div>-->
<!--                                            <div>-->
<!--                                                示例-->
<!--                                                <div style="width:248px;left:-249px">-->
<!--                                                    <p>投注方案：二同号12，不同号2<br/>开奖号码：112,即中二不同号</p>-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                        ...
                        <betting :time="NowTime" :ids="navNum" :betary="betAry" :gameindex="GameIndex" @addnum="addNum"
                                 @emptynum="EmptyNum"
                                 @deletenum="deleteNum" @settrack="setTrack" @direct="AryDirectbet"></betting>
                    </div>
...
<style>
    ...
    .Sievesnum_box > div.one {
        background-image: url(../../static/img/icon/touzi_Draw1.png)
    }

    .Sievesnum_box > div.two {
        background-image: url(../../static/img/icon/touzi_Draw2.png)
    }

    .Sievesnum_box > div.three {
        background-image: url(../../static/img/icon/touzi_Draw3.png)
    }

    .Sievesnum_box > div.four {
        background-image: url(../../static/img/icon/touzi_Draw4.png)
    }

    .Sievesnum_box > div.five {
        background-image: url(../../static/img/icon/touzi_Draw5.png)
    }

    .Sievesnum_box > div.six {
        background-image: url(../../static/img/icon/touzi_Draw6.png)
    }
    ...
    .kuaisan .quick_three_numitem:hover{
        color: #ffffff;
        background: #008573;
        border: 1px solid #008573;
    }
    .kuaisan .quick_three_numitem:hover strong,.kuaisan .quick_three_numitem:hover p{
        color: #ffffff;
    }
    .kuaisan .quick_three_numlist .numitem_select {
        color: white;
        background: #008573;
        border: 1px solid #008573;
    }

    .kuaisan .quick_three_numlist .numitem_select strong {
        color: white;
    }
    ...
    .kuaisan .quick_three_numitem > .quick_three_num {
        font-size: 16px;
        color: #000000;
    }
