        ...
        <div class="advantage">
            <div class="adv_con box_center">
                ...
                <div class="adv_box adv_vip">
                    ...
                    <div class="adv_intro">
                        成为贝捷会员，享受左右在线娱乐优惠及最顶级的游戏体验，超乎您的想象。贝捷一直持续为忠实客户提供与众不同的存款优惠机器多种优惠活动    
                    </div>
                </div>
                <div class="adv_box adv_safe">
                    ...
                    <div class="adv_intro">
                        一个稳定安全的博彩环境。您的隐私权是贝捷极其关注的,所有数据的出入都受到限制及严密监控。   
                    </div>
                </div>
            </div>
        </div>
...
<script>
  ...
  import textScroll from '../../assets/js/textScroll';
  import fadeThis from "../../assets/js/jquery.fadethis.min.js"
