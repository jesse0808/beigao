<template>
    <div class="me_recard_main recharge_record">
        <my-title title-val="充值记录" :title-type=0 @clickCallBack="selectPanel=true"></my-title>
                ...
                <div class="recard-item" v-for="(item,index) in pageData" :key="index">
                    ...
                    <div class="item_content">
                        <div class="content_data">
                            ...
                            <div>充值金额：{{item.RcMoney}}元</div>
                        </div>
                    </div>
                    <div class="item_xian"></div>
                    <div class="item_bottom">
                        <span :class="{'status_color_1':item.Status==2,'status_color_3':item.Status==1}">{{item.StatusText}}</span>
...
<script>
    ...
    import {getInquireRecord} from "../../../util/statistics";
    ...
    export default {
        ...
        methods: {
            ...
            getPageData(loaded, isUp) {
                ...
                getInquireRecord(that.searchData).then(data => {
                    this.$toast.clear()
                    if (data.IsSucess) {
