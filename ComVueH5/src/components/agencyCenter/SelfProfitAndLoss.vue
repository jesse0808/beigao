<template>
    <div class="me_recard_main self_profit_loss">
        <my-title title-val="个人亏盈" :title-type=0 @clickCallBack="selectPanel=true"></my-title>
            ...
            <div v-for="(item, index) in pageData" :key="index">
                <div class="block_recard_main">
                    <div class="title">
                        ...
                        <label>余额：{{item.Balance}}元</label>
                    </div>
                    <div class="item_area">
                        <div class="one_item">
                                <label class='item_title'>充值总额</label>
                                <label>{{item.CashIn}}</label>
                        </div>
                        <div class="one_item">
                                <label class='item_title'>取款总额</label>
                                <label>{{item.CashOut}}</label>
                        </div>
                        <div class="one_item">
                                <label class='item_title'>当前投注</label>
                                <label>{{item.NowBet}}</label>
                        </div>
